...
## Files
- **segmentation_train.py**: Implements and trains the Attention SegNet model for lesion segmentation. 
...
- **classification_train.py**: Lightweight CNN classifier trained using segmented lesion outputs.  
